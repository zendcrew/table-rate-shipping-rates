...
if ( !class_exists( 'WTARS_Shipped_Polylang_Shipping_Rates' ) ) {

    class WTARS_Shipped_Polylang_Shipping_Rates {
        ...
        public function tranlate_title( $title, $rate_id, $instance_id ) {
            ...
            return WTARS_Shipped_Polylang::get_translated_string( $title, $string_id );
        }
        ...
        public function tranlate_tooltip( $tooltip, $rate_id, $instance_id ) {
            ...
            return WTARS_Shipped_Polylang::get_translated_string( $tooltip, $string_id );
        }
        ...
        public function tranlate_desc( $desc, $rate_id, $instance_id ) {
            ...
            return WTARS_Shipped_Polylang::get_translated_string( $desc, $string_id );
        }
        ...
        public function get_strings( $options, $instance_id ) {
            ...
            foreach ( $this->get_shipping_rates( $options ) as $shipping_rate ) {
                ...
                $rate_strings[ $key . 'title' ] = array(
                    'value' => $shipping_rate[ 'title' ],
                    'is_multiline' => true
                );

                $rate_strings[ $key . 'tooltip' ] = array(
                    'value' => $shipping_rate[ 'tooltip' ],
                    'is_multiline' => true
                );

                $rate_strings[ $key . 'desc' ] = array(
                    'value' => $shipping_rate[ 'desc' ],
                    'is_multiline' => true
                );
            }
