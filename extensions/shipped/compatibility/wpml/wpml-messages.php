...
if ( !class_exists( 'WTARS_Shipped_WPML_Messages' ) ) {

    class WTARS_Shipped_WPML_Messages {
        ...
        public function tranlate_message( $message, $message_id, $message_type, $instance_id ) {
            ...
            return WTARS_Shipped_WPML::get_translated_string( $message, $string_id );
        }
        ...
        public function get_strings( $options, $instance_id ) {
            ...
            foreach ( $this->get_messages( $options ) as $message ) {
                ...
                $message_strings[ $key ] = $message[ 'message' ];
            }
