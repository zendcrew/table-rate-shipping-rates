...
<div class="rn-option-page-aside-details" style="<?php echo ReonUtil::array_to_styles($styles);// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
    ...
    <div class="rn-option-page-aside-details-logo"><img src="<?php echo esc_url($option_page_display['image']);// phpcs:ignore PluginCheck.CodeAnalysis.ImageFunctions.NonEnqueuedImage ?>" alt="<?php echo esc_attr($option_page_display['title']); ?>" /></div>
