...
if (!class_exists('Reon_Controls_DateTime')) {

    class Reon_Controls_DateTime {

        public static function init() {
            add_action('reon/render-control-datetime', array(new self(), 'render'), 10, 1);
            add_filter('reon/sanitize-datetime', array(new self(), 'sanitize'), 1, 4);
        }
        ...
        public static function render($field) {
            ...
            if (isset($field['step_second'])) {
                $attributes['data-step-second'] = $field['step_minute'];
            }
